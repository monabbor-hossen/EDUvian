          ...
          child: Padding(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                ...
                if (ref.watch(subjectProvider).isEmpty && ref.watch(departmentProvider) != null)
                  SliverToBoxAdapter(
                    child: Center(
                      child: Padding(
                ...
                if (ref.watch(subjectProvider).isNotEmpty)
                  SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (context, index) {
                        final subject = ref.watch(subjectProvider)[index];
                        return _subjectTile(subject, ref).animate().fadeIn(duration: 300.ms).slideX(begin: 0.2);
                      },
                      childCount: ref.watch(subjectProvider).length,
                    ),
                  ),
